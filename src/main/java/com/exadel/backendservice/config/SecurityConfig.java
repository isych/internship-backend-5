...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.PUT,"/api/events/**/unpublish").hasAnyRole("SUPERADMIN")
                ...
                .antMatchers(HttpMethod.POST,"/api/candidates/**/cv/upload").permitAll()
                ...
                .antMatchers(HttpMethod.GET,"/api/candidates/**/cv/download").hasAnyRole("SUPERADMIN", "ADMIN")
